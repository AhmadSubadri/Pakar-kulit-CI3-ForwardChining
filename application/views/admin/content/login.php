...
<body style="background-color: #26C8E7;">
    <!--  Body Wrapper -->
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-4">
                        <div class="card mb-0" style="background-color: #26C8E7; box-shadow: 5px 10px;">
                            <div class="card-body">
                                <h3 class="text-center">SELAMAT DATANG DI<br>SISTEM PAKAR DIAGNOSA<br>PENYAKIT KULIT</h3><br>

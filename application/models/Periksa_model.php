...
class Periksa_model extends CI_Model
{
    ...
    public function get_penyakit_by_kode($kodePenyakit)
    {
        $this->db->where('kode_penyakit', $kodePenyakit);
        return $this->db->get('tb_penyakit')->row_array();
    }
    ...
    public function get_total_gejala_by_kode_penyakit($kodePenyakit)
    {
